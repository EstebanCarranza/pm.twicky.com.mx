        ...
        var createSlices = function(slider, settings, vars) {
            ...
            for(var i = 0; i < settings.slices; i++){
                ...
                if(i === settings.slices-1){
                    slider.append(
                        $('<div class="nivo-slice" name="'+i+'"><img class=".img-slider" src="'+ vars.currentImage.attr('src') +'display:block !important;top:0; left:-'+ ((sliceWidth + (i * sliceWidth)) - sliceWidth) +'px;" /></div>').css({ 
